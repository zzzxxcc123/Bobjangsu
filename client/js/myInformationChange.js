...
function infoData(data) {
    if ( data.height === undefined) {
        content1 = `<label for="inputName">키</label><input type="text" id="height" maxlength=3 placeholder="미저장">`
    }else{
...
const pageMove = document.getElementById('infochange')
    pageMove.addEventListener('click' , function () {
        ...
        if(sta){
            ...
            var meallist = './myInformationChange.html'
            window.location.href = meallist
        }
    })
